...
#Song Dictionaries
songOne = {'name': 'Song One', 'album': 'Test', 'genre': 'Electronic', 'id': 0}
songTwo = {'name': 'Song Two', 'album': 'Strings', 'genre': 'Electronic', 'id': 1}
songThree = {'name': 'Song Three', 'album': 'Test', 'genre': 'Electronic', 'id': 2}
